...
# Define a function to display the coordinated clicked on the image

def click_events(events, x, y, flags, params):
    if event == cv2.EVENT.LBUTTONDOWN:
        ...
        # Load the template to inscribe the image
        img = cv2.imread('certificate_template.png')
